let jokers = [
	{
		...
		text: ['Discard a <RandomRank>, <RandomRank>, <RandomRank>, and <RandomRank> in that order to gain $10 and a Double Tag. {C:red}Self-destructs.{} {C:grey}Ranks are chosen upon obtaining Combination Lock, and do not change.{}'],
	...
	},
	{
		...
		text: ['Gains $5 Sell Value when played hand contains a Full House.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Common',
	},
	{
	...
	{
		name: 'Antique Joker',
		text: ['When a Silver Card is played, earn $2 for every level of Tarnish removed.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Uncommon',
	},
	{
	...
	{
		name: 'Lycanthropy',
		text: ['X0.15 Mult for every level of Tarnish on each Silver Card in your Full Deck.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Uncommon',
	},
	{
	...
	{
		name: 'Silent Auction',
		text: ['Sell this card to gain a <RandomTag> and a <RandomTag>. Tags change every Round.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Uncommon',
	},
	{
	...
	{
		name: 'Power Stone',
		text: ['Anything that would give X1.5 Mult gives X1.75 Mult instead.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Uncommon',
	},
	{
	...
	{
		name: 'DJ Hallyboo',
		text: ['X4 Mult. Loses X0.1 Mult for every $1 of Sell Value of your other Jokers.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Rare',
	},
	{
		name: 'It\'s Pizza Time!',
		text: ['While Sleeping: +$1 at the end of Round. Gains +$1 when Blind is defeated. While Awake: X0.5 Mult. This cannot be Sold, and will be Destroyed at the end of the Round. {C:attention}Wakes up on the last hand of the Round.{}'],
		image_url: 'assets/placeholder.png',
		rarity: 'Rare',
	},
	{
	...
	{
		name: 'Too Many Cooks',
		text: ['When your consumable slots are full, all new consumables are Negative. When you pick up a Negative Consumable, lose $5.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Rare',
	},
	{
	...
	{
		name: 'Mathurine',
		text: ['+1 Joker Slot. Sell $15 Worth of Jokers to gain +1 Joker Slot.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Legendary',
	},
	{
	...
	{
		name: 'Cyberspace',
		text: ['X0.25 Mult and +$1 at the end of the Round for every Blind Skipped or Boss Blind Defeated.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
	...
	},
	{
		...
		text: ['Adds the sell value of all Jokers to Mult. Add $1 of sell value to every Joker and Consumable card at end of round.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
	...
	},
	{
		...
		text: ['Lucky Cards have activation chances doubled, but also gain a 1 in 6 Chance of being destroyed after being played. Gains 0.25x Mult when a Lucky Card activates.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
	...
	{
		name: 'Royal Family',
		text: ['Each Face Card held in your hand gives +5 Mult, then X1.5 Mult.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
	...
	},
	{
		...
		text: ['Each played card with <Suit> gives X1.5 Mult when scored. Each played card with <Rank> gives X1.5 Mult when scored. {C:grey}Suit and Rank are taken from a Random Card in your Deck.{}'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
	...
	{
		name: 'Stampede',
		text: ['X0.1 Mult for every $4. X2 Mult and Double Interest against Boss Blinds.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
	...
	{
		name: 'Still Life',
		text: ['Cards whose Suit doesn\'t match any previous Card in the hand give X2 Mult when scored.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
	...
	},
	{
		...
		text: ['X0.25 Mult for every unique Tarot Card used this run.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
