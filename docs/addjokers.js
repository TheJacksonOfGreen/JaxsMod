let jokers = [
	...
	{
		name: 'Crisp Twenty',
		text: ['{C:mult}+20{} Mult. {C:mult}-1{} Mult for every {C:money}$1{} you have more or less than {C:money}$20{}.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Common',
	},
	{
	...
	{
		name: 'Thawed Joker',
		text: ['{X:mult,C:white}X1.5{} Mult. {X:chips,C:white}X1.5{} Chips.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Common',
	},
	{
	...
	},
	{
		...
		text: ['After 3 Rounds, sell this to create a Joker that fuses with one of your other Jokers. {C:grey}If you have no fusable Jokers, create a random fusable Joker instead.{}'],
		image_url: 'assets/placeholder.png',
		rarity: 'Common',
	},
	{
		name: 'ミラクルミュージカル',
		text: ['{C:chips}+12{} Chips. {C:mult}+12{} Mult. Sell this after playing 12 Hands for {C:attention}-1 Ante{}, and to stop this from appearing for the rest of the game.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Common',
	},
	{
	...
	{
		name: 'Saucy Joker',
		text: ['{C:mult}+6{} Mult for each Consumable Card held.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Common',
	},
	{
		name: 'Sleight of Hand',
		text: ['Gains {X:chips,C:white}X0.05{} Chips whenever an Ace is scored.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Common',
	},
	{
	...
	{
		name: 'Ugly Sweater',
		text: ['{X:chips,C:white}X2.5{} Chips when played hand contains a Three of a Kind.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Common',
	},
	{
		name: 'Whirlpool',
		text: ['Upgrade all cards in the first Discard of the Round, giving them {C:chips}+10{} Bonus Chips.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Common',
	},
	{
	...
	{
		name: 'Undertaker',
		text: ['Gains {X:chips,C:white}X0.2{} Chips when a Playing Card or Joker is Destroyed.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Uncommon',
	},
	{
		name: 'Wormhole',
		text: ['{C:mult}+1{} Mult for every card Discarded this Round. At the end of each Round, replace all cards you discarded with cards of a random rank, suit, and enhancement.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Uncommon',
	},
	{
	...
	},
	{
		...
		text: ['When you play a Hand, Upgrade all Cards in your Deck, giving them {C:chips}+1{} Bonus Chip.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Rare',
	},
	{
	...
	{
		name: 'D\'Acosta',
		text: ['Gains {X:chips,C:white}X0.05{} Chips for every Chip each card you Discard is valued at. Resets after Hand is Scored.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Legendary',
	},
	{
	...
	},
	{
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Throwback.png", "assets/Rocket.png"],
	},
	{
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Gift_Card.png", "assets/Swashbuckler.png"],
	},
	{
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Lucky_Cat.png", "assets/placeholder.png"],
	},
	{
		name: 'Garden Gnome',
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Marble_Joker.png", "assets/placeholder.png"],
	},
	{
		name: 'Halley\'s Comet',
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Space_Joker.png", "assets/Loyalty_Card.png"],
	},
	{
		name: 'Pajamas',
		text: ['Gains {X:chips,C:white}X0.3{} Chips if hand contains a Full House.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/placeholder.png", "assets/Spare_Trousers.png"],
	},
	{
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Burglar.png", "assets/placeholder.png"],
	},
	{
		name: 'Pseudoisochromatism',
		text: ['{C:chips}+2{} Chips for each remaining card in Deck. 1 in 2 Chance to gain {C:chips}+1{} Chip when a Pack is opened.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Blue_Joker.png", "assets/Hallucination.png"],
	},
	{
		name: 'Royal Family',
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Shoot_the_Moon.png", "assets/Baron.png"],
	},
	{
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Ancient_Joker.png", "assets/The_Idol.png"],
	},
	{
		name: 'Stampede',
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Bull.png", "assets/Matador.png"],
	},
	{
		name: 'Still Life',
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Flower_Pot.png", "assets/Seeing_Double.png"],
	},
	{
		...
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Fortune_Teller.png", "assets/Satellite.png"],
	},
	{
		name: 'Viking Funeral',
		text: ['Level Up the first hand you discard each round. Upgrade all cards that score in that hand, giving them {C:chips}+15{} Bonus Chips.'],
		image_url: 'assets/placeholder.png',
		rarity: 'Fusion',
		fusion_jokers: ["assets/Burnt_Joker.png", "assets/placeholder.png"],
	},
];
...
let consumables = [
	...
	{
	  name: "Charity",
	  text: ["Select 2 Cards, and give them {C:chips}+10{} Bonus Chips."],
	  image_url: "assets/placeholder.png",
	  rarity: "Tarot"
	},
	{
...
let card_modifications = [
 {
   name: "Silver",
   text: [
     "When in hand: {X:chips,C:white}X2{} Chips, +1 Tarnish. Max 4 Tarnish. Each Tarnish takes away {X:chips,C:white}X0.25{} Chips from this card. Remove all Tarnish when this card scores. "
   ],
   image_url: "assets/placeholder.png",
   rarity: "Enhancement"
 },
